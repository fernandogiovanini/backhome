...
func (_m *IConfig) AddFile(filename string) error {
...
func (_m *IConfig) CreateConfigFile() error {
	ret := _m.Called()
...
func (_m *IConfig) GetConfigFilePath() string {
	ret := _m.Called()
...
func (_m *IConfig) GetFilenames() []string {
	ret := _m.Called()
...
func (_m *IConfig) GetLocalPath() (string, error) {
	ret := _m.Called()
...
func (_m *IConfig) GetRemote() string {
	ret := _m.Called()
...
func (_m *IConfig) MakeLocalRepository() error {
	ret := _m.Called()
